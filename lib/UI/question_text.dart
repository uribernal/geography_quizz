...
class QuestionText extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => new QuestionTextSate();

}

class QuestionTextSate extends State<QuestionText> with SingleTickerProviderStateMixin{
    ...
    return new Material(
      ...
      child: new Padding(
        ...
        child: new Center(
          ...
          style: new TextStyle(fontSize: _fontSizeAnimation.value * 22, fontWeight: FontWeight.normal),
          ),
        ),
      ),
    );
