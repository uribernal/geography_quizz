...
class CorrectWrongOverlay extends StatefulWidget{
  ...
  CorrectWrongOverlay(this._timesUp, this._isCorrect, this._onTap);
          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                ...
                child: new Icon(widget._timesUp == true ? Icons.timer: widget._isCorrect == true ? Icons.done: Icons.clear, size: _iconAnimation.value * 80.0),
              ),
            ),
            new Padding(
                padding: new EdgeInsets.only(bottom: 20.0)
            ),
            new Text(widget._timesUp == true ? "Time's up!": (widget._isCorrect == true ? "Correct!" : "Wrong!"), style: new TextStyle(color: Colors.white, fontSize: 30.0),)
          ],
        ),
      ),
    );
